...
async function loadCourses(){
  ...
  snapshot.forEach((childSnapshot)=>{
    ...
    const courseCard = "<div class=\"card\"><img src=\"" + data.image + "\" class=\"card-img-top\"><div class=\"card-body\"><h5 class=\"card-title\">" + data.name + "</h5><p class=\"card-text\">"+ data.description +"</p><button type=\"button\" class=\"btn btn-light\"><a href=\"" + + "\">Enroll Now</a></button></div></div>"    
